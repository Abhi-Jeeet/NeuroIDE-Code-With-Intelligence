...
import { ChevronRight, File, Plus, FilePlus, FolderPlus, MoreHorizontal, Trash2, Edit3, Folder } from 'lucide-react';
            ...
            <Button variant={"ghost"} size={"icon"} className='h-6 w-6 opacity-0 group-hover:opacity-100 transition-opacity'>
                <MoreHorizontal className='h-3 w-3'/>
                    ...
                    <DropdownMenuContent align='end'>
                        ...
                        <DropdownMenuSeparator/>
                        <DropdownMenuItem onClick={hanldeAddFolder}>
                ...
                <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle>Delete Folder</AlertDialogTitle>
                            <AlertDialogDescription>
                                Are you sure you want to delete "{folderName}" and all its content?
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel>Cancel</AlertDialogCancel>
